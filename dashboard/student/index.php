 ...
 * Purpose: Student dashboard home page.
 * Shows enrolled modules with a progress bar for each.
 */
...
<main class="content">
    ...
    <div class="module-list">
        ...
        <?php if (count($enrolled_modules) === 0) { ?>
            ...
            <a href="/LMS-project/dashboard/student/modules.php" class="btn-primary">Browse Modules</a>
        ...
        <?php } else { ?>
            ...
            <?php foreach ($enrolled_modules as $module) {
                ...
                ");
                $stmt3->execute([$user_id, $passing_score, $module['id']]);
            ...
            <a href="/LMS-project/dashboard/student/modules.php" class="btn-secondary">Browse More Modules</a>
